...
| chat-chrome             | NativeChat input chrome                               | Connecting/paused glass above the composer; one item centered independently of the trailing scroll action; 30 pt scroll glass with a 14 pt bold symbol centered on send; 44 pt touch target; paired glasses share a bottom baseline; dropping scroll returns status to center                                                                                                                                                                                                                                                     |
