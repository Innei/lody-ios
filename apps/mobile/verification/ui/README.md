...
| chat-chrome             | NativeChat input chrome                               | Connecting/paused glass above the composer; one item centered independently of the trailing scroll action; 44 pt scroll glass with a 17 pt symbol aligned to send’s leading and trailing edges; paired glasses share a bottom baseline; dropping scroll returns status to center                                                                                                                                                                                                                                                |
