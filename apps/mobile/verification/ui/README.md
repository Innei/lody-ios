...
| process-failed          | NativeChat folded process row                         | Live thinking row with a failed tool in the group: warning mark instead of the pip, orange copy, shine still traveling; screenshots plus video                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
...
Embedded `navigation` does two cold relaunches and one unknown-URL return so the
480s cap can finish the workspace link. English `type_into` retypes when the
