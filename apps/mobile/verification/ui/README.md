...
| chat-chrome             | NativeChat input chrome                               | Connecting/paused glass above the composer; one item centered on the scroll-to-bottom baseline; 22 pt scroll glass with a 44 pt hit; paired glasses keep a 22 pt gap and stay centered as a group; dropping scroll returns status to center                                                                                                                                                                                                                                                                                       |
