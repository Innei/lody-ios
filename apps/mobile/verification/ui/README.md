...
| model-memory            | Shared UIKit form + ChatComposerView                  | Per-model effort and permission restoration across both selection hosts, full-access default; Grok independent permission, boolean fast mode, collaboration and agent preset options; config-only effort                                                                                                                                                                                                                                                                                                                                                                                              |
