...
| duration               | NativeChat assistant duration row                     | Static (non-shiny) first-row duration advances each second; server process follows below while live; completion freezes the OSS-compatible duration and absorbs the folded process into that same row above the final answer                                                                                                                                                                                                                                                 |
