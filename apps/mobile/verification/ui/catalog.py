...
SYSTEM = {
    'en': {'clear': 'Clear text', 'close': 'Close', 'cancel': 'Cancel', 'ok': 'OK', 'copy': 'copy', 'paste': 'Paste', 'nextKeyboard': 'Next keyboard', 'collapse': 'Collapse content', 'shareCopy': 'Copy'},
    'zh-Hans': {'clear': '清除文本', 'close': '关闭', 'cancel': '取消', 'ok': '好', 'copy': '拷贝', 'paste': '粘贴', 'nextKeyboard': '下一个键盘', 'collapse': '折叠内容', 'shareCopy': '拷贝'},
}
